...
{
    /// <summary>
    /// MCECustomersInfo:实体类(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class MCECustomersInfo
    {
        ...
        private string _mailpromotion;
        private string _vendorcode;
        private string _carrier;
        private string _accountno;
        private string _note;
        private string _vatidno;
        ...
        /// 
        /// </summary>
        public string MailPromotion
        {
            set { _mailpromotion = value; }
            get { return _mailpromotion; }
        }
        /// <summary>
        /// 
        /// </summary>
