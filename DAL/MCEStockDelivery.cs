...
{
	/// <summary>
	/// 数据访问类:MCEStockDelivery
	/// </summary>
	public partial class MCEStockDelivery
	{
		public MCEStockDelivery()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "MCEStockDelivery"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from MCEStockDelivery");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(EuSoft.Model.MCEStockDelivery model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into MCEStockDelivery(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(EuSoft.Model.MCEStockDelivery model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update MCEStockDelivery set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MCEStockDelivery ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public EuSoft.Model.MCEStockDelivery GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,StockCatalogNo,StockCSNo,StockSize,StockUnit,StockValCode,StockBatchNo,StockNote,StockLibraryID,SysNote,Reason,StockLocation,UpdateTime,Person from MCEStockDelivery ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			EuSoft.Model.MCEStockDelivery model=new EuSoft.Model.MCEStockDelivery();
		...
		/// 得到一个对象实体
		/// </summary>
		public EuSoft.Model.MCEStockDelivery DataRowToModel(DataRow row)
		{
			EuSoft.Model.MCEStockDelivery model=new EuSoft.Model.MCEStockDelivery();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM MCEStockDelivery ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from MCEStockDelivery T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "MCEStockDelivery";
