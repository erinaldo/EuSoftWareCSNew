...
{
	/// <summary>
	/// 数据访问类:MCEStockSweden
	/// </summary>
	public partial class MCEStockSweden
	{
		public MCEStockSweden()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "MCEStockSweden"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from MCEStockSweden");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(EuSoft.Model.MCEStockSweden model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into MCEStockSweden(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(EuSoft.Model.MCEStockSweden model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update MCEStockSweden set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MCEStockSweden ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public EuSoft.Model.MCEStockSweden GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,StockCatalogNo,StockCSNo,StockSize,StockUnit,StockValCode,StockBatchNo,StockNote,StockLibraryID,SysNote,StockLocation,UpdateTime,Person from MCEStockSweden ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			EuSoft.Model.MCEStockSweden model=new EuSoft.Model.MCEStockSweden();
		...
		/// 得到一个对象实体
		/// </summary>
		public EuSoft.Model.MCEStockSweden DataRowToModel(DataRow row)
		{
			EuSoft.Model.MCEStockSweden model=new EuSoft.Model.MCEStockSweden();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM MCEStockSweden ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from MCEStockSweden T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "MCEStockSweden";
