...
namespace EuSoft.DAL
{
	...
	public partial class SysUser
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(EuSoft.Model.SysUser model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SysUser(");
			strSql.Append("xtId,userid,username,userpwd)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(EuSoft.Model.SysUser model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public EuSoft.Model.SysUser GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,xtId,userid,username,userpwd from SysUser ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			EuSoft.Model.SysUser model=new EuSoft.Model.SysUser();
		...
		/// 得到一个对象实体
		/// </summary>
		public EuSoft.Model.SysUser DataRowToModel(DataRow row)
		{
			EuSoft.Model.SysUser model=new EuSoft.Model.SysUser();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,xtId,userid,username,userpwd ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,xtId,userid,username,userpwd ");
			strSql.Append(" FROM SysUser ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
