...
namespace EuSoft.DAL
{
	...
	/// 数据访问类:MCEStockonWay
	/// </summary>
	public partial class MCEStockonWay
	{
		public MCEStockonWay()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "MCEStockonWay"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from MCEStockonWay");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(EuSoft.Model.MCEStockonWay model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into MCEStockonWay(");
			strSql.Append("StockCatalogNo,StockCSNo,StockSize,StockUnit,StockValCode,StockBatchNo,StockNote,StockLibraryID,SysNote,UpdateTime,Person,UserMCE)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@UserMCE", SqlDbType.VarChar,40)};
			...
			parameters[11].Value = model.UserMCE;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(EuSoft.Model.MCEStockonWay model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update MCEStockonWay set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MCEStockonWay ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public EuSoft.Model.MCEStockonWay GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,StockCatalogNo,StockCSNo,StockSize,StockUnit,StockValCode,StockBatchNo,StockNote,StockLibraryID,SysNote,UpdateTime,Person,UserMCE from MCEStockonWay ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			EuSoft.Model.MCEStockonWay model=new EuSoft.Model.MCEStockonWay();
		...
		/// 得到一个对象实体
		/// </summary>
		public EuSoft.Model.MCEStockonWay DataRowToModel(DataRow row)
		{
			EuSoft.Model.MCEStockonWay model=new EuSoft.Model.MCEStockonWay();
			if (row != null)
			{
				...
				if(row["UserMCE"]!=null)
				{
					model.UserMCE=row["UserMCE"].ToString();
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,StockCatalogNo,StockCSNo,StockSize,StockUnit,StockValCode,StockBatchNo,StockNote,StockLibraryID,SysNote,UpdateTime,Person,UserMCE ");
			strSql.Append(" FROM MCEStockonWay ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,StockCatalogNo,StockCSNo,StockSize,StockUnit,StockValCode,StockBatchNo,StockNote,StockLibraryID,SysNote,UpdateTime,Person,UserMCE ");
			strSql.Append(" FROM MCEStockonWay ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from MCEStockonWay T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "MCEStockonWay";
