...
{
    /// <summary>
    /// 数据访问类:MCECustomersInfo
    /// </summary>
    public partial class MCECustomersInfo
    {
        public MCECustomersInfo()
        { }
        #region  BasicMethod
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "MCECustomersInfo");
        }
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from MCECustomersInfo");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(EuSoft.Model.MCECustomersInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into MCECustomersInfo(");
            strSql.Append("SalesCompany,SalesContactName,SalesStreet,SalesCity,SalesState,SalesZip,SalesCountry,SalesTel,SalesFax,SaleseMail,BillCompany,BillContactName,BillStreet,BillCity,BillState,BillZip,BillCountry,BillTel,BillFax,BilleMail,ShipCompany,ShipContactName,ShipStreet,ShipCity,ShipState,ShipZip,ShipCountry,ShipTel,ShipFax,ShipeMail,Terms,PayMethod,MailPromotion,VendorCode,Carrier,AccountNo,Note,VATIDNo,UpdateTime,Person,Reasons)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@BillStreet", SqlDbType.VarChar,200),
					...
					new SqlParameter("@ShipStreet", SqlDbType.VarChar,200),
            ...
            parameters[40].Value = model.Reasons;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(EuSoft.Model.MCECustomersInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update MCECustomersInfo set ");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from MCECustomersInfo ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public EuSoft.Model.MCECustomersInfo GetModel(int ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,SalesCompany,SalesContactName,SalesStreet,SalesCity,SalesState,SalesZip,SalesCountry,SalesTel,SalesFax,SaleseMail,BillCompany,BillContactName,BillStreet,BillCity,BillState,BillZip,BillCountry,BillTel,BillFax,BilleMail,ShipCompany,ShipContactName,ShipStreet,ShipCity,ShipState,ShipZip,ShipCountry,ShipTel,ShipFax,ShipeMail,Terms,PayMethod,MailPromotion,VendorCode,Carrier,AccountNo,Note,VATIDNo,UpdateTime,Person,Reasons from MCECustomersInfo ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
            ...
            EuSoft.Model.MCECustomersInfo model = new EuSoft.Model.MCECustomersInfo();
        ...
        /// 得到一个对象实体
        /// </summary>
        public EuSoft.Model.MCECustomersInfo DataRowToModel(DataRow row)
        {
            EuSoft.Model.MCECustomersInfo model = new EuSoft.Model.MCECustomersInfo();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM MCECustomersInfo ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from MCECustomersInfo T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "MCECustomersInfo";
