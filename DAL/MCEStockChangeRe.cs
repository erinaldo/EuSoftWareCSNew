...
namespace EuSoft.DAL
{
	...
	public partial class MCEStockChangeRe
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "MCEStockChangeRe"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from MCEStockChangeRe");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into MCEStockChangeRe(");
			strSql.Append("StockCatalogNo,StockCSNo,StockSize,StockUnit,StockValCode,StockBatchNo,StockNote,StockLibraryID,SysNote,StockLocation,ChangeNote,ChangePerson,ChangeTime,Reasons)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@ChangeNote", SqlDbType.VarChar,40),
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update MCEStockChangeRe set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MCEStockChangeRe ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		public EuSoft.Model.MCEStockChangeRe GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,StockCatalogNo,StockCSNo,StockSize,StockUnit,StockValCode,StockBatchNo,StockNote,StockLibraryID,SysNote,StockLocation,ChangeNote,ChangePerson,ChangeTime,Reasons from MCEStockChangeRe ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			EuSoft.Model.MCEStockChangeRe model=new EuSoft.Model.MCEStockChangeRe();
		...
		/// 得到一个对象实体
		/// </summary>
		public EuSoft.Model.MCEStockChangeRe DataRowToModel(DataRow row)
		{
			EuSoft.Model.MCEStockChangeRe model=new EuSoft.Model.MCEStockChangeRe();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,StockCatalogNo,StockCSNo,StockSize,StockUnit,StockValCode,StockBatchNo,StockNote,StockLibraryID,SysNote,StockLocation,ChangeNote,ChangePerson,ChangeTime,Reasons ");
			strSql.Append(" FROM MCEStockChangeRe ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,StockCatalogNo,StockCSNo,StockSize,StockUnit,StockValCode,StockBatchNo,StockNote,StockLibraryID,SysNote,StockLocation,ChangeNote,ChangePerson,ChangeTime,Reasons ");
			strSql.Append(" FROM MCEStockChangeRe ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from MCEStockChangeRe T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "MCEStockChangeRe";
