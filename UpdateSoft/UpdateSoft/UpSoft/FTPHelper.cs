...
namespace UpSoft
{
    ...
    {
        public delegate void UpdateUI(int step, string count);//声明一个更新主线程的委托
        public UpdateUI UpdateUIDelegate;

        public delegate void AccomplishTask();//声明一个在完成任务时通知主线程的委托
        public AccomplishTask TaskCallBack;
        public int taskCount; //任务量为10000
        ...
        public void Download(string filePath, string fileName)
        {
            ...
            try
            {
                ...
                int fileSize = Convert.ToInt32(cl);
                int bufferSize = 2048;
                int readCount;
                ...
                while (readCount > 0)
                {
                    ...
                    readCount = ftpStream.Read(buffer, 0, bufferSize);
                    // UpdateUIDelegate(bufferSize, filename);
                }
                ftpStream.Close();
                outputStream.Close();
                response.Close();
