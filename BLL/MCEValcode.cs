...
namespace EuSoft.BLL
{
	...
	{
		private readonly EuSoft.DAL.MCEValcode dal=new EuSoft.DAL.MCEValcode();
		public MCEValcode()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public EuSoft.Model.MCEValcode GetModelByCache(int ID)
		{
			
			string CacheKey = "MCEValcodeModel-" + ID;
			...
			return (EuSoft.Model.MCEValcode)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.MCEValcode> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.MCEValcode> DataTableToList(DataTable dt)
		{
			List<EuSoft.Model.MCEValcode> modelList = new List<EuSoft.Model.MCEValcode>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				EuSoft.Model.MCEValcode model;
