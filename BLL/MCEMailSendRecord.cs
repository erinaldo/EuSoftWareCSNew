...
namespace EuSoft.BLL
{
	...
	{
		private readonly EuSoft.DAL.MCEMailSendRecord dal=new EuSoft.DAL.MCEMailSendRecord();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public EuSoft.Model.MCEMailSendRecord GetModelByCache(int ID)
		{
			
			string CacheKey = "MCEMailSendRecordModel-" + ID;
			...
			return (EuSoft.Model.MCEMailSendRecord)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.MCEMailSendRecord> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.MCEMailSendRecord> DataTableToList(DataTable dt)
		{
			List<EuSoft.Model.MCEMailSendRecord> modelList = new List<EuSoft.Model.MCEMailSendRecord>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				EuSoft.Model.MCEMailSendRecord model;
