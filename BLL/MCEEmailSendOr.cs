...
namespace EuSoft.BLL
{
	...
	{
		private readonly EuSoft.DAL.MCEEmailSendOr dal=new EuSoft.DAL.MCEEmailSendOr();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public EuSoft.Model.MCEEmailSendOr GetModelByCache(int id)
		{
			
			string CacheKey = "MCEEmailSendOrModel-" + id;
			...
			return (EuSoft.Model.MCEEmailSendOr)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.MCEEmailSendOr> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.MCEEmailSendOr> DataTableToList(DataTable dt)
		{
			List<EuSoft.Model.MCEEmailSendOr> modelList = new List<EuSoft.Model.MCEEmailSendOr>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				EuSoft.Model.MCEEmailSendOr model;
