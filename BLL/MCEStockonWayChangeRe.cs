...
{
	/// <summary>
	/// MCEStockonWayChangeRe
	/// </summary>
	public partial class MCEStockonWayChangeRe
	{
		private readonly EuSoft.DAL.MCEStockonWayChangeRe dal=new EuSoft.DAL.MCEStockonWayChangeRe();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public EuSoft.Model.MCEStockonWayChangeRe GetModelByCache(int ID)
		{
			
			string CacheKey = "MCEStockonWayChangeReModel-" + ID;
			...
			return (EuSoft.Model.MCEStockonWayChangeRe)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.MCEStockonWayChangeRe> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.MCEStockonWayChangeRe> DataTableToList(DataTable dt)
		{
			List<EuSoft.Model.MCEStockonWayChangeRe> modelList = new List<EuSoft.Model.MCEStockonWayChangeRe>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				EuSoft.Model.MCEStockonWayChangeRe model;
