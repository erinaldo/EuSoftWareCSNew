...
namespace EuSoft.BLL
{
	...
	{
		private readonly EuSoft.DAL.SysQxB dal=new EuSoft.DAL.SysQxB();
		public SysQxB()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public EuSoft.Model.SysQxB GetModelByCache(int id)
		{
			
			string CacheKey = "SysQxBModel-" + id;
			...
			return (EuSoft.Model.SysQxB)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.SysQxB> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.SysQxB> DataTableToList(DataTable dt)
		{
			List<EuSoft.Model.SysQxB> modelList = new List<EuSoft.Model.SysQxB>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				EuSoft.Model.SysQxB model;
