...
namespace EuSoft.BLL
{
	...
	{
		private readonly EuSoft.DAL.MCEPaymentInfo dal=new EuSoft.DAL.MCEPaymentInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public EuSoft.Model.MCEPaymentInfo GetModelByCache(int ID)
		{
			
			string CacheKey = "MCEPaymentInfoModel-" + ID;
			...
			return (EuSoft.Model.MCEPaymentInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.MCEPaymentInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<EuSoft.Model.MCEPaymentInfo> DataTableToList(DataTable dt)
		{
			List<EuSoft.Model.MCEPaymentInfo> modelList = new List<EuSoft.Model.MCEPaymentInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				EuSoft.Model.MCEPaymentInfo model;
